namespace BP.Web.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BP.Web.Models.ApplicationDbContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "BP.Web.Models.ApplicationDbContext";
        }

        protected override void Seed(BP.Web.Models.ApplicationDbContext context)
        {
            ...
            var roles = new List<ApplicationRole> {
                ...
                new ApplicationRole { Name = "NavKor", Index = 99999, RoleGroup = roleGroups.FirstOrDefault(x => x.Index == 1000) },
            };
            ...
            if (!context.Users.Any(u => u.UserName == "navkor"))
            {
                var store = new UserStore<ApplicationUser>(context);
                var manager = new UserManager<ApplicationUser>(store);
                var user = new ApplicationUser { UserName = "navkor", Email = "michael@basicallyprepared.com", EmailConfirmed = true };
                manager.Create(user, "ChangeItAsap!");
                manager.AddToRole(user.Id, "NavKor");
            }
        }
    }
}
